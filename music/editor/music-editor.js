    ...
    function handleEditorInput(e, editor) {
        ...
        switch(e.type) {
            case 'keydown':
                ...
                const selectedInstruction = editor.selectedInstructions[0]; // editor.gridDataGetInstruction(selectedData);
...
//         console.log("Grid " + e.type, gridItem);
    ...
    function renderGrid(editor) {
        ...
        let editorHTML = '', rowHTML = '', pauseCount = 0;
        for(let i=0; i<instructionList.length; i++) {
            ...
            switch(instruction.type) {
                ...
                case 'pause':
                    ...
                    editorHTML += `<div class="grid-row ${pauseCSS.join(' ')}" data-beats-per-minute="${beatsPerMinute}">`;
                    editorHTML += rowHTML;
                    editorHTML += `</div>`;
                    rowHTML = '';
